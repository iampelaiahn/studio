...
_s(OrderProvider, "SJnJK+0tG6siqWoAZPoTVp15bgA=");
_c = OrderProvider;
function useOrder() {
    _s1();
...
function AvailabilityModal({ isOpen, onOpenChange }) {
    _s();
    const { setCustomerDetails } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$order$2d$context$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useOrder"])();
...
_s(AvailabilityModal, "Hd46NmTtN4+DyTQ3Wrg5DX7NSJ0=", false, function() {
    return [
...
_s(Header, "kAO1dbBt8ZRZq2nmTwhqtC9Pc0E=", false, function() {
    return [
...
//# sourceMappingURL=src_18d01867._.js.map