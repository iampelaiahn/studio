...
function Header() {
    ...
    const renderNavLinks = (isMobile = false)=>{
        return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["navLinks"].map((link)=>{
            const className = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])('font-medium transition-colors hover:text-primary whitespace-nowrap', isMobile ? 'text-lg' : 'text-sm', pathname === link.href ? 'text-primary' : 'text-foreground/60');
